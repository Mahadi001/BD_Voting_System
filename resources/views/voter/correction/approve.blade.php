...
<div class="container">
    ...
    <div class="row">
      ...
      {!! Form::open(['action' => ['CorrectionController@update', $corrections->id], 'method' => 'POST']) !!} 
      <div class="row">
   ...
   <div class="row">
      ...
      <div class="col-md-4 mb-3">
          ...
          {{Form::select('state', ['dk'=>'dhaka','bd'=>'bang'],  $corrections->state, ['class' => 'form-control', 'placeholder' => 'Choose'])}}
      </div>
      <div class="col-md-4 mb-3">
